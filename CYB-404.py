...
\033[1;37m╔\033[1;36mⒸ︎Ⓨ︎Ⓑ︎\033[1;37m══════\033[41m\033[1;37m[ 𓆩𝗙𝗨𝗖𝗞 𝗬𝗢𝗨 𝗕𝗔𝗬𝗣𝗔𝗦𝗦 𝗨𝗦𝗘𝗥𓆪 ]\x1b[0m══════\033[1;36mⒸ︎Ⓨ︎Ⓑ︎ 
\033[1;31m│\033[1;37m👉  \033[1;32mOWNER\033[1;31m      ➟\033[1;32m𓆩 𝐒 𝐇 𝐀 𝐍 𝐓 𝐎𓆪    \033[1;31m      ‌‌‌‌‌‌‌
...
def XYZ():
    ...
    print(f" {GREEN}PREMIUM USER          {WHITE}: {GREEN}Mr {GREEN} {NameX}")
    print(f"{BLUE}══════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}PAK RANDOM CLONE 🔥 ")
    print(f"{RED}[02] {WHITE}FEEDBACK 🙂 ")
    print(f"{RED}[03] {WHITE}JOIN MESSENGER GROUP 💛 ")
    ...
    if WASIM in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/shantotx90?mibextid=JRoKGi")
        XYZ()
    elif WASIM in ["3","03"]:
...
def pass1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN}["+tl+"] ~> P1   ")
        print(f" {WHITE}YOUR NAME             : {BLUE}"+NameX)
...
def pass2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN}["+tl+"] ~> P2 ")
        print(f" {WHITE}YOUR NAME             : {BLUE}"+NameX)
        print(f" {WHITE}NUMBER YOU PUT        : {YELLOW}"+code)
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
        print(f'{RED}======================================================')
...
def Ulti():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN}["+tl+"] ~> Ulti ")
        print(f" {WHITE}YOUR NAME             : {BLUE}"+NameX)
        print(f" {WHITE}NUMBER YOU PUT        : {YELLOW}"+code)
...
def pass3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN }["+tl+"] ~> P4 ")
        print(f" {WHITE}YOUR NAME             : {BLUE}"+NameX)
        print(f" {WHITE}NUMBER YOU PUT        : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝗦𝗛𝗔𝗡𝗧𝗢 🔥] [%s] \33[1;97m[OK:%s{𝗦𝗛𝗔𝗡𝗧𝗢2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
